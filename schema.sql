...
('Nalam PHC', 'A comprehensive Healthcare Management System designed for Primary Health Centers. Streamlines patient registration, appointment scheduling, medical records management, and real-time analytics for healthcare providers.', 'https://github.com/skemparaj', 'https://nalam-phc-9cj7.vercel.app/', 'Java, Spring Boot, MySQL, HTML/CSS, JavaScript'),
('Marriage Booking Event Management', 'A full-featured Event Planning & Booking Platform for marriage venues. Enables seamless venue browsing, date availability checking, package customization, guest management, and online booking confirmations.', 'https://github.com/skemparaj', 'https://marriage-frontend-ten.vercel.app/', 'Java, Spring MVC, MySQL, Bootstrap, Thymeleaf'),
